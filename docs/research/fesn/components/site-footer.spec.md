...
## Overview
- **Target file:** `src/clones/fesn/components/SiteFooter.astro`
...
## Assets
- `public/clones/fesn/images/logo-fesn-white.svg` (alt `Logo FESN`)
- `public/clones/fesn/images/reclame-aqui-otimo.png` (alt `Selo de avaliação Reclame Aqui da FESN`)

...
## Overview
- **Target file:** `src/components/StudentCardFound.astro`
...
## Assets
- `public/images/bg-student-card-2026.png` (decorative background)
- `public/images/logo-dne-color.png` (alt `Logo DNE`), `public/images/logo-fesn-short.svg` (alt `Logo FESN`)
- `public/images/mock-student-photo.svg`, `public/images/mock-qr.svg` — **mock**, see below
